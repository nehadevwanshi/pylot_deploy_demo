...
"""
routes['default_controller'] = 'CourseCon'
"""
...
"""
routes['POST']['/process'] = 'CourseCon#process'
routes['POST']['/add'] = 'CourseCon#add'
routes['GET']['/course/destroy/<int:course_id>']= 'CourseCon#destroy'
routes['POST']['/remove']= 'CourseCon#remove'
